  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved journal as @journal" do
        ...
        post :create, {:journal => { "name" => "invalid value" }}, valid_session
        assigns(:journal).should be_a_new(Journal)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested journal" do
        ...
        Journal.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => journal.to_param, :journal => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the journal as @journal" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Journal.any_instance.stub(:save).and_return(false)
        put :update, {:id => journal.to_param, :journal => { "name" => "invalid value" }}, valid_session
        assigns(:journal).should eq(journal)
      end
